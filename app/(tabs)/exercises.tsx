  ...
  const exercises: Exercise[] = [
    {
      ...
      description:
        "Mejora el equilibrio y fortalece las piernas con movimientos controlados.",
      device: "Banda IMU",
      duration: "60 seg",
      difficulty: "Fácil",
      calories: 15,
    ...
    },
    {
      ...
      description:
        "Trabaja el equilibrio lateral desplazando el peso de un lado a otro.",
    ...
    },
    {
      ...
      description:
        "Mejora el tiempo de reacción tocando los pads que se iluminan.",
    ...
    },
    {
      ...
      description:
        "Ejercicio de rotación del tronco manteniendo el equilibrio.",
      device: "Disco de Equilibrio",
      duration: "60 seg",
      difficulty: "Difícil",
      calories: 30,
    ...
    >
      ...
      <View style={styles.filterContainer}>
        ...
        >
          <TouchableOpacity
            ...
            activeOpacity={0.7}
          >
            <ThemedText style={[styles.filterChipText, { color: colors.card }]}>
              Todos
            </ThemedText>
          </TouchableOpacity>
          <TouchableOpacity
            ...
            <View style={styles.exerciseContent}>
              ...
              <View
                style={[
                  ...
                  { backgroundColor: getDeviceColor(exercise.device) + "15" },
                ]}
              >
                <IconSymbol
                  name={exercise.icon as any}
                  size={32}
                  color={getDeviceColor(exercise.device)}
                />
              </View>
                ...
                <View style={styles.exerciseMeta}>
                  <View
                    style={[
                      styles.deviceBadge,
                      {
                        backgroundColor: getDeviceColor(exercise.device) + "20",
                      },
                    ]}
                  >
                    <ThemedText
      ...
      >
        ...
        <View style={styles.tipsText}>
          ...
          <ThemedText
            style={[styles.tipsDescription, { color: colors.textSecondary }]}
          >
            Realiza los ejercicios en un espacio seguro, con buena iluminación y
            cerca de un apoyo.
          </ThemedText>
        </View>
      </ThemedView>
