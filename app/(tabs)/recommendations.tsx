...
export default function RecommendationsScreen() {
  ...
  const mentalExercises: MentalExercise[] = [
    ...
    },
    {
      ...
      description:
        "Ejercicios de matemáticas básicas para mantener la mente ágil.",
      duration: "8-10 min",
      difficulty: "Moderado",
      icon: "function",
      category: "Razonamiento",
  ...
  const healthTips: HealthTip[] = [
    {
      ...
      description:
        "Bebe al menos 6-8 vasos de agua al día. La hidratación es crucial para el funcionamiento cognitivo.",
      icon: "drop.fill",
      category: "Nutrición",
    },
    {
      ...
      description:
        "Duerme 7-8 horas diarias. Un buen descanso mejora la memoria y el equilibrio.",
      icon: "moon.fill",
      category: "Descanso",
    },
    {
      ...
      description:
        "Mantén contacto regular con familia y amigos. Las relaciones sociales protegen la salud mental.",
      icon: "person.2.fill",
      category: "Social",
    },
    {
      ...
      description:
        "Incluye frutas, verduras y proteínas magras en tu dieta. Omega-3 es beneficioso para el cerebro.",
      icon: "leaf.fill",
      category: "Nutrición",
    },
  ];
    ...
    >
      ...
      <ThemedView style={styles.section}>
        ...
        >
          <View style={styles.featuredContent}>
            <View
              style={[styles.featuredIcon, { backgroundColor: colors.card }]}
            >
              <IconSymbol
                name={mentalExercises[0].icon as any}
                size={32}
                color={colors.primary}
              />
            </View>
            <View style={styles.featuredText}>
              <ThemedText
                style={[styles.featuredTitle, { color: colors.card }]}
              >
          ...
          >
            ...
            <View style={styles.tipContent}>
              <View style={styles.tipHeader}>
                ...
                >
                  <ThemedText
                    style={[styles.tipCategoryText, { color: colors.primary }]}
                  >
                    {tip.category}
                  </ThemedText>
                </View>
      ...
      >
        ...
        <View style={styles.ctaText}>
          ...
          <ThemedText
            style={[styles.ctaDescription, { color: colors.secondary }]}
          >
